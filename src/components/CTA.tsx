  ...
  return (
    <section className="relative py-20 sm:py-28 overflow-hidden">
      ...
      <div className="relative max-w-3xl mx-auto px-5 sm:px-8 text-center reveal">
        <h2 className="font-display text-3xl sm:text-5xl font-extrabold text-white tracking-tight leading-tight">Ready to Trade With Confidence?</h2>
        <p className="mt-5 text-lg sm:text-xl text-brand-100 max-w-xl mx-auto">Join FSMM and experience a safer, smarter way to trade in Steal a Brainrot.</p>
        <div className="mt-8 flex justify-center">
          <a href={DISCORD_INVITE} target="_blank" rel="noopener noreferrer" className="group inline-flex items-center justify-center gap-2.5 rounded-2xl bg-white px-8 py-4 text-base font-bold text-brand-700 shadow-2xl shadow-brand-950/30 hover:bg-brand-50 hover:shadow-2xl hover:shadow-brand-950/40 transition-all duration-300 hover:-translate-y-1 active:translate-y-0 active:scale-95">
