...
const SERVER_LOGO = '/server-logo.svg';
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
        <div className="text-center lg:text-left">
          ...
          <p className="mt-5 text-lg sm:text-xl text-slate-600 max-w-xl mx-auto lg:mx-0 animate-fade-up" style={{ animationDelay: '160ms' }}>
            FSMM is a Steal a Brainrot community built around reliable middleman support, base painting, trusted trades, and a straightforward place to meet other traders.
          </p>
          ...
          <div className="relative mx-auto max-w-md">
            ...
            <div className="relative rounded-[2rem] bg-white shadow-2xl shadow-brand-900/10 border border-brand-100 p-6 animate-float">
              ...
              <div className="mt-4 space-y-3">
                {[
                  { name: 'base-paints', msg: 'Base painting requests and availability.', color: 'bg-brand-500' },
                  { name: 'middleman', msg: 'Middleman requests handled through tickets.', color: 'bg-emerald-500' },
                  { name: 'trade-chat', msg: 'A place to discuss trades with other players.', color: 'bg-amber-500' },
                ].map((c) => (
