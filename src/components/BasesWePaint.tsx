...
// Images are loaded from the official Steal a Brainrot Wiki media files.
// Keeping the wiki file redirects here means the cards use the real in-game base art instead of placeholders.
const FANDOM = 'https://stealabrainrot.fandom.com/wiki/Special:Redirect/file/';

const bases = [
  { name: 'Candy', requirement: '100% of the eligible Candy Index', status: 'Past mutation index', image: `${FANDOM}Candy_Base.png` },
  { name: 'Lava', requirement: '100% of the eligible Lava Index', status: 'Past mutation index', image: `${FANDOM}Lava_Base.png` },
  { name: 'Galaxy', requirement: '100% of the eligible Galaxy Index', status: 'Past mutation index', image: `${FANDOM}Galaxy_Base.png` },
  { name: 'Yin Yang', requirement: '75% of the eligible Yin Yang Index', status: 'Past mutation index', image: `${FANDOM}Yin_Yang_Base.png` },
  { name: 'Radioactive', requirement: '75% of the eligible Radioactive Index', status: 'Past mutation index', image: `${FANDOM}Radioactive_Base.png` },
  { name: 'Cursed', requirement: '60% of the eligible Cursed Index', status: 'Past mutation index', image: `${FANDOM}Cursed_Base.png` },
  { name: 'Divine', requirement: '60% of the eligible Divine Index', status: 'Past mutation index', image: `${FANDOM}Divine_Base.png` },
  { name: 'Cyber', requirement: '60% of the eligible Cyber Index', status: 'Past mutation index', image: `${FANDOM}Cyber_Base.png` },
  { name: 'Phantom', requirement: '60% of the eligible Phantom Index', status: 'Check the live Index', image: `${FANDOM}Phantom_Base.png` },
  { name: 'Crystal', requirement: '50% of the Crystal Index', status: 'Newer mutation base', image: `${FANDOM}Crystal_Base.png` },
];
    ...
    <section id="base-paints" className="relative py-20 sm:py-28 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-5 sm:px-8">
        <div className="max-w-3xl mx-auto text-center reveal">
          ...
          <p className="mt-4 text-lg text-slate-600">Browse the real mutation base skins from the Steal a Brainrot Wiki. Select a base to see the current index target, then confirm the exact service availability in Discord.</p>
        </div>
          ...
          {bases.map((base, i) => (
            <button key={base.name} type="button" onClick={() => setSelected(base)} className={`group relative overflow-hidden rounded-3xl border border-brand-100 bg-white/95 p-4 text-left shadow-sm hover:-translate-y-2 hover:shadow-2xl hover:shadow-brand-600/15 transition-all duration-500 reveal reveal-delay-${(i % 4) + 1}`}>
              ...
              <div className="aspect-square rounded-2xl bg-slate-50 border border-slate-100 overflow-hidden flex items-center justify-center">
                <img src={base.image} alt={`${base.name} base skin`} className="h-full w-full object-cover group-hover:scale-105 transition-transform duration-500" loading="lazy" referrerPolicy="no-referrer" />
              </div>
